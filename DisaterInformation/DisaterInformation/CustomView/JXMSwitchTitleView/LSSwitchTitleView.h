...
- (instancetype)initWithFrame:(CGRect)frame titleArray:(NSArray *)titleArray textColor:(UIColor *)textColor selectedColor:(UIColor *)selectedColor lineViewColor:(UIColor *)lineViewColor bgColor:(UIColor *)bgColor lineViewColor:(NSString *)lineColor selecte:(void(^)(NSInteger index))selecte;
