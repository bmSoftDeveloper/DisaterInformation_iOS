...
- (instancetype)initWithFrame:(CGRect)frame titleArray:(NSArray *)titleArray textColor:(UIColor *)textColor selectedColor:(UIColor *)selectedColor lineViewColor:(UIColor *)lineViewColor bgColor:(UIColor *)bgColor lineViewColor:(NSString *)lineColor selecte:(void (^)(NSInteger))selecte
{
    self = [super initWithFrame:frame];
    if (self) {
...
//            btn.tag = 2000 + i;
            ...
            if (i == 0) {
                ...
                _selectedBtn = btn;
                UIView *lineView = [[UIView alloc]init ];
                lineView.backgroundColor = [UIColor colorWithRGBString:lineColor];
                [self addSubview:lineView];
                ...
                [lineView mas_makeConstraints:^(MASConstraintMaker *make) {
                    ...
                    make.width.offset(1);
                    make.height.offset(btn.frame.size.height- 10);
                }];
